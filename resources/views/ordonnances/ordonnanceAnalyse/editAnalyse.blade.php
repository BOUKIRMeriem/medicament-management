      ...
      <div class="col-md-8">
          <div class="my-3 p-3 bg-body rounded shadow-sm" style="width:100%;">
              <div style="display: flex; align-items: center;">
                  ...
                  <h3 style="margin-left: 5px;">édition une ordonnance d'analyse médicale</h3>
              </div>
              <div class="mt-4">
                  
                <form style="width: 80%;" method="POST" action="{{route('analyse.update',['analyse'=>$analyse->id])}}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3" style="flex: 1; margin-left: 80px;">
                      ...
                      <select class="form-select" name="consultation_id">
                        ...
                        @endphp
                        @if ($consultation->id == $analyse->consultation_id)
                    ...
                    <div class="mb-3" style="flex: 1; margin-left: 80px;">
                      ...
                      <input type="text" class="form-control" name="special_instructions" value="{{ $analyse->special_instructions }}">
                    </div>
