      ...
      <div class="col-md-8">
          <div class="my-3 p-3 bg-body rounded shadow-sm" style="width:100%;">
              <div style="display: flex; align-items: center;">
                  ...
                  <h3 style="margin-left: 5px;">Edition un User</h3>
              </div>
              
                  <form style="width:80%;" method="post"  action="{{route('user.update',['user'=>$user->id])}}">
                      @csrf
                      @method('PUT')
                      ...
                      <div class="mb-3" style="margin-left: 80px;">
                        ...
                        <input type="password" class="form-control" name="mot_de_passe" value="{{ $user->mot_de_passe }}" >
